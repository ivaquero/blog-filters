...
class PDA(Generic[ET]):
    ...
    def association_probabilities(
        ...
        *,
        ...
        log_a = -special.logsumexp(lls)
        lls_normalized = log_a + lls

        # probabilities
        return np.exp(lls_normalized)
    ...
    def update(
        ...
        *,
        ...
        # reduce mixture
        return self.reduce_mixture(filter_state_update_mixture)
    ...
    def step(
        ...
        *,
        ...
        return self.update(Z, filter_state_predicted, sensor_state=sensor_state)
